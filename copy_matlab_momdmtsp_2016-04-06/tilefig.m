...
%TILE 1 or more FIGures. % Tiles the screen for existing figures starting at the top left hand corner.
...
%omar addn is number of rows
    numfigcols(n)=ceil(numfigs/n);
end
