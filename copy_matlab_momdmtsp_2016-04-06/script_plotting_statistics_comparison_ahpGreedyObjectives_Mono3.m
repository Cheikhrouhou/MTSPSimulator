...
function script_plotting_statistics_comparison_ahpGreedyObjectives_Mono3(ni, nf, ns, stp, dim, showPlot)
...
% 
%      %GC
%     gc=w1*AvgGA(:,3) + w2*Avgot(:,3)
%     errorbar(Avgot(:,1),gc,Erot(:,3),'o-','Color',clr(2,:))
...
%     legend('TTD, w=\{0.26, 0.19, 0.54\}','MT, w=\{0.26, 0.19, 0.54\}','GC, w=\{0.26, 0.19, 0.54\}',...
%         'TTD, w=\{1,0,0\}', 'MT w=\{1,0,0\}', 'GC, w=\{0.26, 0.19, 0.54\}',...
%         'TTD w=\{0,1,0\}', 'MT w=\{0,1,0\}', 'GC, w=\{0.26, 0.19, 0.54\}' , ...
%         'TTD w=\{0,0,1\}', 'MT w=\{0,0,1\}', 'GC, w=\{0.26, 0.19, 0.54\}' )
%     legend('TTD, w=\{0.26, 0.19, 0.54\}','MT, w=\{0.26, 0.19, 0.54\}','GC, w=\{0.26, 0.19, 0.54\}',...
%         'TTD, w=\{1,0,0\}', 'MT w=\{1,0,0\}', 'GC, w=\{1,0,0\}',...
%         'TTD w=\{0,1,0\}', 'MT w=\{0,1,0\}', 'GC, w=\{0,1,0\}' , ...
%         'TTD w=\{0,0,1\}', 'MT w=\{0,0,1\}', 'GC, w=\{0,0,1\}' )
   % legend('boxoff')
