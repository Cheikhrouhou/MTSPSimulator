...
%Date: 11-11-2015
%tsp= lkh
function [rte, brk, globalCost]=momdmtsp_ahpGreedyImproved(Targets, depots, compMat, show_prog)
...
% end
        ...
        if(show_prog)
            %create_newfigure();
            fig_name=sprintf('Multi-Robot Simulator, Improvement phase',param);%-%s, cputime
